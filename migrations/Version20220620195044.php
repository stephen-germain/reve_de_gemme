 ...
 */
final class Version20220620195044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE categorie categories_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE categories_id categorie INT NOT NULL');
    }
}
